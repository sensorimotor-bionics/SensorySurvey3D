function row_annotation_viewer(Survey3DData,qualities,three_dim,subject,mesh_source)
    ...
    fig_width = panel_width + 3*spacing;

    fig = uifigure('Name','Rowwise Annotation Viewer','Position',[0 0 fig_width+(num_columns)*col_width max([num_per_column*23,panel_width])]);
    ...
    uitextarea(fig,'Position',[text_xstart max([num_per_column*21,360])+10 (num_columns)*col_width 20],'Value','Parsed File Details',...
